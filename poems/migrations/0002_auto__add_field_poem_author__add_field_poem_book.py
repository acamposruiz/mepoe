...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poem.author'
        db.add_column(u'poems_poem', 'author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'Poem.book'
        db.add_column(u'poems_poem', 'book',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poem.author'
        db.delete_column(u'poems_poem', 'author')

        # Deleting field 'Poem.book'
        db.delete_column(u'poems_poem', 'book')
