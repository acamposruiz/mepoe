...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'poems_poem', (
            ...
            ('has_title', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('params', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='42,6,1', max_length=5)),
        ...
        # Adding model 'Line'
        db.create_table(u'poems_line', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('body', self.gf('django.db.models.fields.CharField')(max_length=79)),
            ('poem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poems.Poem'])),
        ))
        db.send_create_signal(u'poems', ['Line'])
    ...
    models = {
        ...
        u'poems.line': {
            ...
            'body': ('django.db.models.fields.CharField', [], {'max_length': '79'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'poems.poem': {
            ...
            'has_title': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'params': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "'42,6,1'", 'max_length': '5'}),
